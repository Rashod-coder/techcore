  ...
  return (
          ...
          <div className="card mx-auto" style={{ backgroundColor: '#4D6D97' }}>
           ...
           <br></br>
            ...
            <h4 className='mt-2'style={{fontSize: '20px', color: 'white', fontFamily: 'oxygen'}}> Incase the google form isn't working on this page click on  <a href='https://forms.gle/MjG7qKcBwmHykcpM7'> this </a>link to fill it out</h4>
      </div>
    </div>
  );
}
