...
function TextExample() {
  return (
          ...
          <div className="card mx-auto" style={{ backgroundColor: '#C9EAF1' }}>
            ...
            <h3 className='text-dark'style={{color:'black',fontSize: '20px', color: 'white', fontFamily: 'oxygen'}}>Techcore and  FYC are currently teaching two courses Advanced Python and Introduction to Python to grades 5-12</h3>
            <br></br>
            ...
            <h3 className='mt-2 text-black' style={{color:'black',fontSize: '20px', color: 'white', fontFamily: 'oxygen'}}>As well as python is heavily used in AI/ML applications</h3>
           <br></br>
