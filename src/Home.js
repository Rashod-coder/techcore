...
function HomePage() {
  return (
    <div style={{ backgroundColor: '#9899A1', height: '100vh', padding: '20px' }}>
      <br />
      <br />
      ...
      <div style={{ backgroundColor: 'white', padding: '10  px', border: '2px solid black', borderRadius: '20px', width: '20%', margin: '2 0px auto' }}>
